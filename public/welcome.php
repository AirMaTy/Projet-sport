...
<body>
    ...
    <main>
        ...
        <section class="utilisation">
            ...
            <ul>
                <li><a href="<?= BASE_URL ?>/public/joueurs/liste.php">Gestion des Joueurs</a> : pour voir, ajouter, et modifier les informations de vos joueurs.</li>
                <li><a href="<?= BASE_URL ?>/public/matchs/liste.php">Gestion des Matchs</a> : pour consulter les matchs, ajouter de nouveaux matchs, et enregistrer les résultats.</li>
                <li><a href="<?= BASE_URL ?>/public/feuilles_match/visualiser.php">Feuilles de Match</a> : pour préparer la sélection des joueurs pour chaque rencontre.</li>
                <li><a href="<?= BASE_URL ?>/public/statistiques/index.php">Statistiques</a> : pour consulter les statistiques d'équipe et individuelles des joueurs.</li>
            </ul>
        </section>
